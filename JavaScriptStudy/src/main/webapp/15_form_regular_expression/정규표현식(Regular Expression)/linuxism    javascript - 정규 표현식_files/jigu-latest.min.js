...
daum.Ajax.prototype.callFailure = function() {
	try {
		if (typeof this.XHR === 'object' && (this.XHR.status == 500 || this.XHR.status == 503)) {
			document.createElement('img').src = 'http://group1.magpie.daum.net/magpie/opencounter/Open.do?service=tistory&key=' + this.XHR.status;
		}
	} catch(e) { }
